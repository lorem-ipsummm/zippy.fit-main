...
A running club that helps get your competitive juices flowing. 
    ...
    modal.style.display = "block";}} className='btn add'> Enlist Club</button>
...
Zippy is world’s first move to earn metaverse focused on outdoor and indoor runners, joggers and walkers.
    ...
    <button onClick={()=>{
      window.location.assign("mailto:xyz@abc.com");}} className='btn add'> Write To Us</button>
    {/* <p>Get your club enlisted</p> */}
